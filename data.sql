...
# Database: dev
# Generation Time: 2019-03-07 01:53:31 +0000
# ************************************************************
...
INSERT INTO `user` (`id`, `firstName`, `lastName`, `password`, `emailAddress`, `profileUrl`, `isAdmin`)
VALUES
	(1,'admin','admin','admin','admin','profilePhotos/72b5ef99b4af895a0128ee74d7a624b8',1),
	(4,'b','b','b','b',NULL,0);
